...
def get_routes(dims, grid, difficulty):
    ...
    arrival_points, finish_points, road_dir, junction = get_add_mat(dims, grid, difficulty) #Adjust this

    n_turn1 = 0 # 0 - straight, 1-right, 2-left --USED TO BE 3
    n_turn2 = 0
    ...
    for i in range(len(arrival_points)):
        paths = []
        # turn 1
        for turn_1 in range(n_turn1): #THESE FOR LOOPS ARE NOT CALLED
            # turn 2
